...
const ExecutiveTemplate = ({ data }) => {
  ...
  return (
    <div className="bg-white p-8 shadow-lg max-w-4xl mx-auto" id="resume-template">
      ...
      <div className="border-b-4 border-gray-800 pb-4 mb-6">
        <div className="flex items-start gap-6">
          ...
          {personalInfo.profileImage && (
            <div className="w-24 h-24 rounded-lg overflow-hidden border-4 border-gray-800 flex-shrink-0 shadow-lg">
              <img
      ...
      {summary && (
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-2 border-b-2 border-gray-800 pb-1">ABOUT ME</h2>
      ...
      {experience.length > 0 && (
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3 border-b-2 border-gray-800 pb-1">PROFESSIONAL EXPERIENCE</h2>
      ...
      {(skills.technical.length > 0 || skills.soft.length > 0) && (
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3 border-b-2 border-gray-800 pb-1">SKILLS</h2>
