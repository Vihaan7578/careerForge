  ...
  return (
    <div className="bg-white p-8 shadow-lg max-w-4xl mx-auto" id="resume-template">
      ...
      <div className="relative mb-6">
        <div className="absolute inset-0 bg-gradient-to-br from-pink-100 via-purple-50 to-mint-100 rounded-lg -z-10"></div>

        <div className="relative p-6 rounded-lg">
          <div className="flex items-start gap-6">
            {/* Profile Image */}
            {personalInfo.profileImage && (
              <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-pink-300 flex-shrink-0 shadow-lg">
                <img
      ...
      {summary && (
        <div className="mb-6">
          <div className="bg-gradient-to-r from-pink-100 to-purple-100 rounded-lg p-4 border-l-4 border-pink-300">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            {experience.map((exp, index) => (
              <div key={index} className="bg-gradient-to-r from-mint-50 to-pink-50 rounded-lg p-4 border-l-4 border-mint-300">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            {education.map((edu, index) => (
              <div key={index} className="bg-gradient-to-r from-purple-50 to-mint-50 rounded-lg p-4 border-l-4 border-purple-300">
      ...
      {(skills.technical.length > 0 || skills.soft.length > 0) && (
        <div className="mb-6">
          <h2 className="text-xl font-bold text-pink-800 mb-3 flex items-center gap-2">
            <Palette className="w-5 h-5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.technical.map((skill, index) => (
                    <span key={index} className="bg-gradient-to-r from-pink-100 to-purple-100 text-pink-800 px-3 py-1 rounded-full text-sm font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            {skills.soft.length > 0 && (
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Creative Skills</h4>
                <div className="flex flex-wrap gap-2">
                  {skills.soft.map((skill, index) => (
                    <span key={index} className="bg-gradient-to-r from-mint-100 to-purple-100 text-mint-800 px-3 py-1 rounded-full text-sm font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
