...
import { Mail, Phone, MapPin, Linkedin, Globe, Palette, Lightbulb } from 'lucide-react';
  ...
  return (
    <div className="bg-white p-8 shadow-lg max-w-4xl mx-auto" id="resume-template">
      ...
      <div className="relative mb-6">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-purple-100 via-pink-50 to-orange-100 rounded-lg -z-10"></div>

        <div className="relative p-6 rounded-lg">
          <div className="flex items-start gap-6">
            {/* Profile Image */}
            {personalInfo.profileImage && (
              <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-purple-400 flex-shrink-0 shadow-lg">
                <img
      ...
      {summary && (
        <div className="mb-6">
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg p-4 border-l-4 border-purple-400">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            {experience.map((exp, index) => (
              <div key={index} className="bg-gradient-to-r from-orange-50 to-pink-50 rounded-lg p-4 border-l-4 border-orange-400">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.soft.map((skill, index) => (
                    <span key={index} className="bg-gradient-to-r from-orange-100 to-pink-100 text-orange-800 px-3 py-1 rounded-full text-sm font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
