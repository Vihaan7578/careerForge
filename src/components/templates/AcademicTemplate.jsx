...
import { Mail, Phone, MapPin, Linkedin, Globe, BookOpen, GraduationCap, Award } from 'lucide-react';
      ...
      <div className="border-b-4 border-red-800 pb-4 mb-6">
        <div className="flex items-start gap-6">
          ...
          {personalInfo.profileImage && (
            <div className="w-24 h-24 rounded-lg overflow-hidden border-4 border-red-800 flex-shrink-0 shadow-lg">
              <img
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            {experience.map((exp, index) => (
              <div key={index} className="border-l-4 border-red-400 pl-4 bg-red-50 rounded-r-lg p-4">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {skills.technical.length > 0 && (
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Research & Technical Skills</h4>
            ...
            {skills.soft.length > 0 && (
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Academic & Teaching Skills</h4>
                <div className="flex flex-wrap gap-2">
